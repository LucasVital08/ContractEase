...
/** Os quatro lugares onde o usuário realmente precisa ir. */
export const PRIMARY_NAV = [
  { to: '/inicio', icon: 'solar:home-smile-bold-duotone', label: 'Início' },
  { to: '/criar', icon: 'solar:add-circle-bold-duotone', label: 'Criar contrato' },
  { to: '/contracts', icon: 'solar:folder-with-files-bold-duotone', label: 'Meus contratos' },
  { to: '/carteira', icon: 'solar:wallet-2-bold-duotone', label: 'Carteira' },
] as const;

/** Tudo o que existe, mas não faz parte do caminho principal. */
const SECONDARY_NAV = [
  { to: '/templates', icon: 'solar:copy-linear', label: 'Modelos prontos' },
  { to: '/smart-contracts', icon: 'solar:cpu-bolt-linear', label: 'Catálogo de escrow' },
  { to: '/opportunities', icon: 'solar:bolt-circle-linear', label: 'Oportunidades' },
